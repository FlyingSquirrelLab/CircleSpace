...
public class MessageController {
  ...
  private String devHeeApikey;

  @Value("${coolsms.devHee.apisecret}")
  private String devHeeApiSecret;

  @Value("${coolsms.devHee.fromnumber}")
  private String devHeeFromNumber;
  ...
  public void init() {
    this.messageService = NurigoApp.INSTANCE.initialize(
        devHeeApikey, devHeeApiSecret, "https://api.coolsms.co.kr");
  }
  ...
  public ResponseEntity<String> sendMessage(@PathVariable String phoneNumber) {
    try {
      ...
      message.setFrom(devHeeFromNumber);
